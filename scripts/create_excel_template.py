...
SEED_ROWS: dict[str, list[list[str]]] = {
    ...
    "Sources": [
        ...
        [
            "SRC-ALPHAFOLD-DB",
            "AlphaFold Structure Database (EBI)",
            "external-api",
            "https://alphafold.ebi.ac.uk",
            "high",
            "Open source structure predictions for 200M+ proteins. pLDDT confidence scores provided.",
        ],
        [
            "SRC-LENIA-MATH",
            ...
            "medium",
            "Continuous cellular automata for emergent geometry generation. Mathematical patterns not literal biology.",
        ],
        [
            "SRC-TURING-SIM",
            "Turing Patterns Reaction-Diffusion Simulator",
            "simulation-framework",
            "https://github.com/joserenter1a/turing_patterns",
            "medium",
            "Gray-Scott and FitzHugh-Nagumo reaction-diffusion pattern generators. Morphogenesis simulation.",
        ],
        [
            "SRC-TURING-1952",
            ...
            "high",
            "Foundational paper on reaction-diffusion pattern formation. Philosophical Transactions Royal Society.",
        ],
        [
            "SRC-ALPHAFOLD-NATURE-2021",
            "AlphaFold Nature Paper 2021",
            "paper",
            "https://doi.org/10.1038/s41586-021-03819-2",
            "high",
            "Highly accurate protein structure prediction with AlphaFold. CASP14 breakthrough paper.",
        ],
    ],
    "ProductIdeas": [
        [
    ...
    "ExternalAgents": [
        [
            ...
            "Structure prediction for protein geometry inference; cracks 1D sequence → 3D geometry code",
            "AlphaFold DB (200M+ structures), EBI API, pLDDT confidence scores",
            "sequence→structure→pocket extraction→geometry mapping",
            "Generate geometry signatures, confidence scoring, candidate docking validation",
            "SHADOW-ALPHAFOLD-001",
            "Backbone→curve/fold, Pocket→GEO-BINDING-POCKET-CAVITY, Surface→polarity_pattern",
            "CAND-MENTHOL-CRYSTAL,CAND-CAPSAICIN-EXTRACT",
            "SRC-ALPHAFOLD-DB",
        ],
        [
            "AGENT-LENIA-001",
            "Lenia Agent",
            "emergent-geometry-simulator",
            "https://github.com/Chakazul/Lenia",
            "Mathematical life simulation for emergent geometry discovery; cracks geometry → life-like behavior",
            "Lenia pattern library (gliders, oscillators, static forms), continuous cellular automata",
            "kernel params → emergent morphology → geometry classification",
            "Generate novel geometry signatures, model temporal dynamics, simulate autonomous patterns",
            "SHADOW-LENIA-001",
            "Glider→waveform+periodic, Oscillator→GEO-TEMPORAL-PULSE-TRAIN, Static→surface_film",
            "CAND-YEAST-BLOOM-MASH,CAND-ESSENTIAL-OIL-DIFFUSER,CAND-CITRONELLA-CANDLE",
            "SRC-LENIA-MATH",
        ],
        [
            "AGENT-TURING-001",
            ...
            "https://github.com/joserenter1a/turing_patterns",
            "Reaction-diffusion pattern generator for morphogenesis geometry; cracks chemistry → pattern → biology",
            "Pattern library (spots, stripes, spirals, labyrinths), Gray-Scott/FitzHugh-Nagumo systems",
            "RD parameters → pattern class → geometry signature (TURING-CORAL-001, etc.)",
            "Generate morphogenesis patterns, validate temporal geometry algebra, predict bifurcations",
            "SHADOW-TURING-001",
            "Spots→periodic_point_set, Stripes→parallel_line_array, Spirals→GEO-TEMPORAL-PULSE-TRAIN",
            "CAND-YEAST-BLOOM-MASH,CAND-BAKING-SODA-PASTE,CAND-ESSENTIAL-OIL-DIFFUSER",
            "SRC-TURING-SIM",
        ],
    ],
    "ShadowAgents": [
        [
            "SHADOW-ALPHAFOLD-001",
            "AGENT-ALPHAFOLD-001",
            "Track latent variables in protein structure prediction (MSA entropy, attention patterns, recycling convergence)",
            "MSA_Entropy, Attention_Pattern, Template_Weight, Recycling_Convergence",
            "pLDDT_variance, MSA_depth, Convergence_RMSD",
            "Attention rollout, Gradient-based attribution, Ensemble variance",
            "pLDDT_variance>0.3, MSA_depth<100, No_template_hits, Recycling_oscillation",
            "YAML: latent_variables, confidence_distribution, convergence_status, prediction_horizon",
            "d(confidence)/dt = α·(information_gain) - β·(noise_accumulation)",
            "Alphafold flexible region → GeometrySignature dynamics parameter",
            "Template_vs_DeNovo, Topology_Switch, Oligomer_State transitions",
        ],
        [
            "SHADOW-LENIA-001",
            "AGENT-LENIA-001",
            "Track continuous state variables in mathematical life (potential field, growth kernel, stability margin)",
            "Potential_Field, Growth_Kernel, Growth_Function, Stability_Margin",
            "Kernel_radius_R, Time_scale_T, Growth_center_mu, Growth_width_sigma",
            "Potential field interpolation, Kernel deconvolution, Stability analysis (Jacobian eigenvalues), Correlation tracking",
            "Period_doubling, Glider_velocity_variation>5%, Pattern_emergence, Collision_imminent",
            "YAML: latent_fields, geometry_parameters, pattern_tracking, stability_analysis",
            "d(u)/dt = G(K * u), ∇²u, ∫u dt",
            "LENIA-OSCILLATOR-001 ↔ GEO-TEMPORAL-PULSE-TRAIN (mathematical oscillator → biological pulse)",
            "Glider→Oscillator (velocity→0), Static→Moving, Stable→Chaotic, Birth_event",
        ],
        [
            "SHADOW-TURING-001",
            "AGENT-TURING-001",
            "Track reaction-diffusion dynamics (activator/inhibitor fields, instability growth, wavelength selection)",
            "Activator_Field_u, Inhibitor_Field_v, Diffusion_Ratio, Reaction_Rates, Turing_Eigenvalue",
            "Du, Dv, f_feed_rate, k_kill_rate, λ_critical",
            "Spatial FFT, Phase field tracking, Defect detection, Parameter estimation",
            "|∂u/∂t|>threshold, Du/Dv crosses 0.5, f/k drift>10%, Wavelength change>20%",
            "YAML: latent_fields, RD_parameters, stability_analysis, pattern_metrics, temporal_evolution",
            "∂u/∂t = Du·∇²u + R(u,v), ∇²u, FFT(u), ∫(u+v)dA",
            "TURING-CORAL-001 ↔ GEO-SURFACE-TEXTURE-RIDGE (RD coral → surface ridge microstructure)",
            "Homogeneous→Pattern (Turing threshold), Spots→Stripes, Stationary→Traveling, Ordered→Chaotic",
        ],
    ],
}
